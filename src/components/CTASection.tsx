...
const CTASection = () => {
  return <section id="cta-final" className="bg-accent section-padding">
      <div className="container-narrow text-center">
        ...
        <Button variant="cta" size="xl" asChild>
          <a target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3" href="https://wa.me/5531987321761">
